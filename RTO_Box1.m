...
clear all
rig.datapath = 'D:\Documents\MATLAB\Behavior Reward Learning\Dreadds Gad2 and VGlut1\RTO'; %What folder you will save in
...
RewardTone = input('Rewarded (CS+) tone frequency ','s');% Rewarded Tone Frequency

%% Initiating arduino
e = arduino('com6','mega2560');% Arduino you are communicating to;

% Tone Designation
if RewardTone == strcat('9000')
    RewardToneFrequency=9000;
    NoRewardToneFrequency=1000;
elseif RewardTone == strcat('1000')  
    RewardToneFrequency=1000;
    NoRewardToneFrequency=9000;
end

% Variables
LT=.045; %The open time for the solenoid. Determines the size of the reward. 
...
Trial.Type=ones(TotalTrials);%allocates 1 array
...
Licking.Sucrose.Licks = zeros(TotalTrials,1000);
...
readDigitalPin(e,LickingDataPin)
pause(1)
readDigitalPin(e,LickingDataPin)
pause(1)
readDigitalPin(e,LickingDataPin)
...
Licking.Habituation.Licks(CurrentTrial,HabCounter) = readDigitalPin(e,LickingDataPin);% places lick measures into the matrix
...
LickCounter=0;     
    ...
    playTone(e,TonePin,RewardToneFrequency,ToneDuration); %reward tone
    Trial.Time(CurrentTrial) = etime(clock,StartTime); % Creates array with time tone played
        ...
        Licking.Reward.Licks(CurrentTrial,ToneCounter) = readDigitalPin(e,LickingDataPin); %Collects lick data into the matrix
        Licking.Reward.Time(CurrentTrial,ToneCounter) = etime(clock,ToneStartTime); % Collects timestamps for licking data

        
            if readDigitalPin(e,LickingDataPin)==1
            LickCounter=LickCounter+1;
            end
        end
 
                if LickCounter >= 1
                writeDigitalPin(e,'D8',1); %Delivers reward
                pause(LT); % Duration of reward
                writeDigitalPin(e,'D8',0); %Stops reward delivery
                Trial.RewardGiven(CurrentTrial)=1;     
                disp('Got it!')
                end
        ...
        Licking.Sucrose.Licks(CurrentTrial,RewardCounter) = readDigitalPin(e,LickingDataPin);
        Licking.Sucrose.Time(CurrentTrial,RewardCounter) = etime(clock,ToneStartTime);
    ...
    ITICurrent=ITI(CurrentTrial);%Chooses ITI that corresponds to the current rial number
    ...
    Licking.ITI.Licks(CurrentTrial,ITICounter) = readDigitalPin(e,LickingDataPin);% places lick measures into the matrix
...
SuccessfullTrials = (sum(Trial.RewardGiven)/TotalTrials)*100;
disp(SuccessfullTrials)

%%
clear all
%%
                writeDigitalPin(e,'D8',1); %Delivers reward
                pause(.045); % Duration of reward
                writeDigitalPin(e,'D8',0); %Stops
%% Initiate spout
writeDigitalPin(e,'D8',1)
pause(70)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
writeDigitalPin(e,'D8',0)